import Protobuf from './protobuf-2.3.1.min.js'
  ...
  (function(RongIMLib) {
    var Navigation = (function() {
      ...
      Navigation.prototype.getServerEndpoint = function(token, appId, _onsuccess, _onerror, unignore) {
        ...
        var tpl = '{domain}/{path}.json?appId={appId}&token={token}&callBack=getNavi&v={sdkver}';
        ...
        var formatNavi = function(result, callback) {
    ...
    var ServerDataProvider = (function() {
      ...
      */
      ...
      ServerDataProvider.prototype.getRemoteHistoryMessages = function(conversationType, targetId, timestamp, count, callback) {
        ...
        var modules = new RongIMLib.RongIMClient.Protobuf.HistoryMessageInput(),
          self = this;
